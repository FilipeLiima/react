...
export function Portfolio() {
  ...
  return (
    <div id="projetos" className="bg-black flex flex-col items-center text-start mb-8 mt-8 max-w-[1400px] font-Inter">
      ...
      <div className="mb-4">
        <div className="flex flex-wrap justify-center gap-4">
          {["TESLA SUPERCHARGER", "CRYPTO HOME", "SMARTBETS", "HYDRO V1", "ENGINEER WORKS"].map(
            (label, idx) => (
              <button
                key={idx}
